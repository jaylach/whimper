...
// If we have a default task, and haven't specified a task
// push our default task onto our list of tasks to run.
var hasDefault = whimp.hasTask(whimp.defaultTask);
if ( hasDefault && taskNames.length === 0 ) {
  taskNames.push(whimp.defaultTask);
}

// If we still don't have any tasks to run, show usage.
